...
class PageCrudController extends CrudController
{
    ...
    public function setup($template_name = false)
    {
        ...
        $modelClass = config('backpack.pagemanager.page_model_class', 'App\Models\Page');
    ...
    public function edit($id, $template = false)
    {
        ...
        $this->addDefaultPageFields($template);
        if($template == 'developed'){
            $this->crud->removeFields(['slug', 'name', 'template'], 'update');
        } else {
            $this->crud->removeFields(['name', 'template'], 'update');
        }
