    ...
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addFields([
            ...
            ['name' => 'description', 'label' => 'Описание', 'type' => 'textarea'],
            ['name' => 'gallery_id', 'label' => 'Галерея', 'type' => 'select2',  'entity' => 'gallery',  'attribute' => 'title',  'model' => "App\Models\Gallery"],
            ['name' => 'image', 'label' => 'Изображение', 'type' => 'image', 'upload' => true, 'prefix' => 'uploads/min/', 'crop' => true, 'aspect_ratio' => .71]
        ]);
