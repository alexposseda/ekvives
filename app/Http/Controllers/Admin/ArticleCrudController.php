    ...
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addFields([
            ...
            [
                'name' => 'content', 'label' => 'Контент', 'type' => 'ckeditor',
                'attributes' => ['required' => 'required']
            ],
            ['name' => 'published_at', 'label' => 'Дата публикации', 'type' => 'datetime_picker'],
            ['name' => 'video', 'label' => 'Видео', 'type' => 'video'],
            ['name' => 'use_video', 'label' => 'Использовать видео?', 'type' => 'checkbox'],
            ...
            [
                'name' => 'image', 'label' => 'Главное изображение',
