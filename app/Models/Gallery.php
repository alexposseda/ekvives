...
class Gallery extends Model
{
    ...
    protected $fillable = ['title', 'slug', 'published_at', 'photos', 'image', 'meta_title', 'meta_description', 'no_index', 'seo_text', 'banner'];
    protected $casts = ['published_at' => 'datetime', 'photos' => 'array'];
    protected $translatable = ['title', 'meta_title', 'meta_description', 'seo_text'];
    ...
    protected $image_properties = [
        ...
        'banner' => [
            ...
            'disk' => 'uploads',
            'destination_path' => 'gallery_banners',
            'quality' => 100
        ]
    ];
