                        ...
                        <div class="buttomDateSplit">
                            ...
                            <div class="button reviewBtnWrap">
                                @if($document->file && $document->file != '/uploads/')
                                    <a href="{{url()->to($document->file)}}" class="btn btn-sm btn-theme-colored" target="_blank">@lang('pages.documents.download')</a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="thumb mt-20">
                            ...
                            <div class="icons-holder fullSizeCover">
                                <div class="icons-holder-inner fullSizeCover mrReset">
                                    <a data-lightbox="image" href="{{url()->to($document->getPhoto('image', 'big'))}}" class="fullSizeCoverBtn">
                                        <i class="fa fa-picture-o"></i>
                                    </a>
                                </div>
                            </div>
                            <a class="hover-link" data-lightbox="image" href="{{url()->to($document->getPhoto('image', 'big'))}}">@lang('pages.documents.view_more')</a>
                        </div>                        
                    </div>
                    @empty @endforelse
                </div>
