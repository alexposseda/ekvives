        ...
        <div class="row border-bottom-black">
                ...
                <div class="widget dark">
                    ...
                    <ul class="list-inline mt-5 footerContacts">
                        ...
                        <li class="m-0 pl-10 pr-10">
                            ...
                            <a class="text-gray" href="tel: @lang('footer.phone')">@lang('footer.phone')</a>
                        </li>
                        @endif
                        ...
                        <li class="m-0 pl-10 pr-10">
                            ...
                            <a class="text-gray" href="//@lang('footer.site')" target="_blank">@lang('footer.site')</a>
                        </li>
                        @endif
                    </ul>
                        ...
                        <article class="post media-post clearfix pb-0 mb-10">
                            ...
                            <div class="post-right">
                                <h5 class="post-title mt-0 mb-5">
                                    <a href="{{$testimonial->file && $testimonial->file != '/uploads/' ? $testimonial->file : '#'}}" download>{{$testimonial->title}}</a>
                                </h5>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    ...
                    <form id="footer_quick_contact_form" name="footer_quick_contact_form" class="quick-contact-form" action="/subscribe" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
                            <input id="form_name" name="name" class="form-control" type="text" required="" placeholder="@lang('footer.name_placeholder')">
                        </div>
                        <div class="form-group">
                            <input id="form_email" name="email" class="form-control" type="email" required="" placeholder="@lang('footer.email_placeholder')">
                        </div>
                        <div class="form-group">
                            <input id="form_company" name="company" class="form-control" type="text" required="" placeholder="@lang('footer.company_placeholder')"></textarea>
                        </div>
                        <div class="form-group">
                            <input id="form_botcheck" name="form_botcheck" class="form-control" type="hidden" value="" />
                            <button type="submit" class="btn btn-default btn-transparent btn-xs btn-flat mt-0" data-loading-text="@lang('footer.loading_text')">@lang('footer.submit')</button>
                        </div>
                    </form>
